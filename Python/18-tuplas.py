...
print(my_tuple.count("Sharif"))#Cuenta las ocurrencias de lo ingresado y busca cuántos de ellos hay en la tupa
print(my_tuple.index(1.80))#Nos indica el índice donde se encuentra el dato puesto en la función
