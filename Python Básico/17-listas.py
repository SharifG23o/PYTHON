...
# Es una forma algo 'Rebuscada' y algo complicada de aplicarlo en un programa
print(edad)
...
# Muestra el número de ocurrencias de un dato o elemento que haya en la lista
print(mi_otra_lista.count("Sharif"))
...
print(mi_otra_lista)
# Elimina lo asignado en la lista, o el primero que ha encontrado
...
# del es delete y elimina el elemento específico de ese índice en la lista, en resumen, elimina por índice
del mi_otra_lista[1]
...
# Se hace un slice o sublista de los elementos que hay entre ciertos índices
print(mi_otra_lista_2[1:3])
...
# Ya NO es lista, puesto que he definido la variable como una de tipo str
print(mi_lista)
